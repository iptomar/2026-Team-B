...
const models: TsoaRoute.Models = {
    ...
    "ApprovalActionParams": {
        ...
        "properties": {
            ...
            "attachment": {"dataType":"nestedObjectLiteral","nestedProperties":{"type":{"dataType":"string","required":true},"name":{"dataType":"string","required":true},"data":{"dataType":"string","required":true}}},
        },
        "additionalProperties": false,
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    "ApprovalEventResponse": {
        ...
        "properties": {
            ...
            "attachmentData": {"dataType":"union","subSchemas":[{"dataType":"string"},{"dataType":"enum","enums":[null]}],"required":true},
            "attachmentName": {"dataType":"union","subSchemas":[{"dataType":"string"},{"dataType":"enum","enums":[null]}],"required":true},
            "attachmentType": {"dataType":"union","subSchemas":[{"dataType":"string"},{"dataType":"enum","enums":[null]}],"required":true},
    ...
    "PipelineStep": {
        ...
        "properties": {
            ...
            "attachmentData": {"dataType":"union","subSchemas":[{"dataType":"string"},{"dataType":"enum","enums":[null]}]},
            "attachmentName": {"dataType":"union","subSchemas":[{"dataType":"string"},{"dataType":"enum","enums":[null]}]},
            "attachmentType": {"dataType":"union","subSchemas":[{"dataType":"string"},{"dataType":"enum","enums":[null]}]},
            "assignedRoleNames": {"dataType":"array","array":{"dataType":"string"}},
            "approvalMode": {"dataType":"string"},
            "requiredApprovals": {"dataType":"double"},
            "outcome": {"dataType":"string"},
            "nodeEvents": {"dataType":"array","array":{"dataType":"nestedObjectLiteral","nestedProperties":{"attachmentType":{"dataType":"union","subSchemas":[{"dataType":"string"},{"dataType":"enum","enums":[null]}]},"attachmentName":{"dataType":"union","subSchemas":[{"dataType":"string"},{"dataType":"enum","enums":[null]}]},"attachmentData":{"dataType":"union","subSchemas":[{"dataType":"string"},{"dataType":"enum","enums":[null]}]},"eventCreatedAt":{"dataType":"string"},"note":{"dataType":"string"},"action":{"dataType":"string","required":true},"actorName":{"dataType":"string","required":true}}}},
        },
        "additionalProperties": false,
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        const argsFormSubmissionController_getStatusCountAll: Record<string, TsoaRoute.ParameterSchema> = {
                req: {"in":"request","name":"req","required":true,"dataType":"object"},
        };
        app.get('/formSubmissions/stats/status-count',
            ...(fetchMiddlewares<RequestHandler>(FormSubmissionController)),
            ...(fetchMiddlewares<RequestHandler>(FormSubmissionController.prototype.getStatusCountAll)),

            async function FormSubmissionController_getStatusCountAll(request: ExRequest, response: ExResponse, next: any) {

            // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa

            let validatedArgs: any[] = [];
            try {
                validatedArgs = templateService.getValidatedArgs({ args: argsFormSubmissionController_getStatusCountAll, request, response });

                const controller = new FormSubmissionController();

              await templateService.apiHandler({
                methodName: 'getStatusCountAll',
                controller,
                response,
                next,
                validatedArgs,
